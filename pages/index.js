                ...
                >
                  <m.main variants={fade} className="">
                    <div className="flex flex-wrap lg:flex-nowrap flex-row h-screen min-h-screen lg:max-h-[100vh]">
                      <section className="w-[100vw] min-w-[100vw] h-full px-[25px] lg:pl-[90px] lg:pr-0 whitespace-normal bg-yellow relative overflow-hidden" data-scroll-section>
                          ...
                          <div className="w-full lg:w-8/12 xl:w-9/12 lg:flex lg:flex-wrap lg:h-full text-soft-black-dark pb-16">
                            ...
                            <div className="w-full flex space-x-3 lg:space-x-5 mt-auto lg:px-[30px]">
                              <div className="w-auto">
                                ...
                                <a href="#" className="group w-full block bg-off-white uppercase text-center rounded-full px-4 lg:px-8 py-4 lg:py-5 text-[16px] lg:text-[23px] relative overflow-hidden">
