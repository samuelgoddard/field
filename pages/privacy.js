                  ...
                  <m.main variants={fade} className="">
                    <div className="">
                        ...
                        <div className="relative pl-[20px] lg:pl-[90px]">
                          ...
                          <div className="pl-[15px] lg:pl-[75px] py-8 lg:py-20 border-b border-soft-black-dark">
                            ...
                            <span className="flex items-center lg:text-lg mt-10">
                              ...
                              <span className="block">Last Updated: 12 August 2021</span>
                            </span>
                          </div>
                        </div>
                      </section>
                      ...
                      <section className="relative" data-scroll-section>
                        ...
                        <div className="relative pl-[20px] lg:pl-[90px]">
                          <div className="px-[30px] py-[40px] pb-[70px] lg:p-[75px] lg:pb-[120px] w-11/12 lg:w-8/12 ml-auto border-l border-soft-black-dark">
                            ...
                            <li>
                            <strong>Website</strong> refers to Field Energy, accessible from <a href="https://www.field.energy" rel="external nofollow noopener" target="_blank">https://www.field.energy</a>
                            </li>
                            <li>
                            ...
                            <ul>
                            <li>By email: hello@field.energy</li>
                            </ul>
                            </div>
                          </div>
                        </div>
